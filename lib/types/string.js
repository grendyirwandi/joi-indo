...
module.exports = Any.extend({
    ...
    messages: {
        ...
        "string.base": "{{#label}} harus berupa karakter",
        ...
        "string.guid": "{{#label}} harus GUID yang valid",
        "string.hex": "{{#label}} hanya boleh berisi karakter heksadesimal",
        "string.hexAlign": "{{#label}} representasi yang didekodekan hex harus sejajar dengan byte",
        "string.hostname": "{{#label}} harus nama host yang valid",
        "string.ip": "{{#label}} harus alamat ip yang valid dengan {{#cidr}} CIDR",
        "string.ipVersion": "{{#label}} harus alamat ip yang valid dari salah satu versi berikut {{#version}} dengan {{#cidr}} CIDR",
        "string.isoDate": "{{#label}} harus dalam format iso",
        "string.isoDuration": "{{#label}} harus dalam durasi ISO 8601 yang valid",
        "string.length": "{{#label}} panjang minimal {{#limit}} karakter",
        "string.lowercase": "{{#label}} hanya boleh berisi karakter huruf kecil",
        "string.max": "{{#label}} panjang minimal kurang dari atau sama dengan {{#limit}} karakter",
        "string.min": "{{#label}} panjang minimal setidaknya sepanjang {{#limit}} karakter",
        "string.normalize": "{{#label}} harus menjadi unicode yang dinormalisasi dalam bentuk {{#form}}",
        "string.token": "{{#label}} hanya boleh berisi karakter alfanumerik dan garis bawah",
        "string.pattern.base": "{{#label}} dengan nilai {:[.]} gagal untuk mencocokkan pola yang diperlukan: {{#regex}}",
        ...
        "string.pattern.invert.name": "{{#label}} dengan nilai {:[.]} cocok dengan pola {{#name}} terbalik",
        "string.trim": "{{#label}} tidak boleh memiliki spasi kosong di depan atau di belakang",
        "string.uri": "{{#label}} harus menjadi uri yang valid",
        "string.uriCustomScheme": "{{#label}} harus berupa uri yang valid dengan skema yang cocok dengan pola {{#scheme}}",
        "string.uriRelativeOnly": "{{#label}} harus menjadi uri relatif yang valid",
